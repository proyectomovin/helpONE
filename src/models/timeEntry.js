 ...
 * @class TimeEntry
 *
 * @property {User} owner User who logged this time entry
 * @property {Date} date Date when the time was logged
 * @property {Number} hours Number of hours worked
 * @property {String} description Description of tasks performed
 * @property {Boolean} deleted Soft delete flag
 */
var timeEntrySchema = mongoose.Schema({
