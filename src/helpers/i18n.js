...
const es = {
  ...
  nav: {
    ...
    customerGroups: 'Empresas',
    teams: 'Equipos',
    departments: 'Departamentos',
    reports: 'Reportes',
    generate: 'Generar',
    groupBreakdown: 'Desglose por Empresa',
  ...
  accountModal: {
    ...
    groupValidation: 'Por favor seleccione una empresa para este usuario.',
  ...
  reports: {
    ...
    ticketsByGroups: 'Tickets por Empresas',
    ...
    instruction: 'Por favor seleccione las fechas de inicio y fin y qué empresas incluir en el reporte.',
  ...
  departments: {
    ...
    allGroupsQuestion: '¿Acceso a todas las empresas actuales y nuevas?',
    publicGroupsQuestion: '¿Acceso a todas las empresas públicas actuales y nuevas?',
    groupRequiredError: 'No se puede crear un departamento sin una empresa seleccionada o todas las empresas habilitadas!',
    teamRequiredError: 'No se puede crear un departamento sin un equipo seleccionado!',
    allGroups: 'Todas las Empresas',
    allPublicGroups: 'Todas las Empresas Públicas',
    deleteConfirm: '¿Está seguro?',
    deletePermanent: 'Esta es una acción permanente.',
  ...
  groups: {
    title: 'Empresas',
    createGroup: 'Crear Empresa',
    editGroup: 'Editar Empresa',
    deleteGroup: 'Eliminar Empresa',
    groupName: 'Nombre de la Empresa',
    groupNameValidation: 'Por favor ingrese un nombre de empresa válido. (Debe contener 2 caracteres)',
    groupMembers: 'Miembros de la Empresa',
    saveGroup: 'Guardar Empresa',
    sendNotificationsTo: 'Enviar Notificaciones A',
    groupActions: 'Acciones de la Empresa',
    deleteConfirm: '¿Está seguro?',
    deletePermanent: 'Esta es una acción permanente.',
    deleteWarning: 'Los agentes pueden perder acceso a recursos una vez que esta empresa sea eliminada.',
    deleteTicketWarning: 'Las empresas que están asociadas con tickets no pueden ser eliminadas.'
  },
  ...
  settingsPermissions: {
    ...
    viewAllTicketsInGroups: 'Puede Ver Todos los Tickets en Empresas Asignadas',
    import: 'Importar',
    activate: 'Activar',
