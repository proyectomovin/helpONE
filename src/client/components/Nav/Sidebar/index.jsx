      ...
      >
              ...
              >
                <Submenu id='settings'>
                  ...
                  <SubmenuItem
                    ...
                    text={t('nav.elasticsearch')}
                    icon={'search'}
                    active={activeSubItem === 'settings-elasticsearch'}
                  />
                  <SubmenuItem
                    text={t('nav.backupRestore')}
                    icon='archive'
        ...
        <div className='side-nav-bottom-panel'>
          <a id='expand-menu' className='no-ajaxy' href='#'>
            <i className='material-icons'>menu</i>{t('nav.collapseMenu')}
          </a>
        </div>
      </div>
    )
