...
export const FETCH_DASHBOARD_TOP_TYPES = defineAction('FETCH_DASHBOARD_TOP_TYPES', [SUCCESS, PENDING, ERROR])
export const FETCH_DASHBOARD_TOP_ASSIGNEES = defineAction('FETCH_DASHBOARD_TOP_ASSIGNEES', [SUCCESS, PENDING, ERROR])
export const FETCH_DASHBOARD_TOP_PRIORITIES = defineAction('FETCH_DASHBOARD_TOP_PRIORITIES', [
  SUCCESS,
  PENDING,
  ERROR
])
export const FETCH_DASHBOARD_TOP_OWNERS = defineAction('FETCH_DASHBOARD_TOP_OWNERS', [SUCCESS, PENDING, ERROR])
...
export const FETCH_WEBHOOKS = defineAction('FETCH_WEBHOOKS', [SUCCESS, PENDING, ERROR])
export const CREATE_WEBHOOK = defineAction('CREATE_WEBHOOK', [SUCCESS, PENDING, ERROR])
export const UPDATE_WEBHOOK = defineAction('UPDATE_WEBHOOK', [SUCCESS, PENDING, ERROR])
export const DELETE_WEBHOOK = defineAction('DELETE_WEBHOOK', [SUCCESS, PENDING, ERROR])
export const TEST_WEBHOOK = defineAction('TEST_WEBHOOK', [SUCCESS, PENDING, ERROR])

// Automation Rules
export const FETCH_AUTOMATION_RULES = defineAction('FETCH_AUTOMATION_RULES', [SUCCESS, PENDING, ERROR])
export const FETCH_AUTOMATION_EVENTS = defineAction('FETCH_AUTOMATION_EVENTS', [SUCCESS, PENDING, ERROR])
export const CREATE_AUTOMATION_RULE = defineAction('CREATE_AUTOMATION_RULE', [SUCCESS, PENDING, ERROR])
export const UPDATE_AUTOMATION_RULE = defineAction('UPDATE_AUTOMATION_RULE', [SUCCESS, PENDING, ERROR])
export const DELETE_AUTOMATION_RULE = defineAction('DELETE_AUTOMATION_RULE', [SUCCESS, PENDING, ERROR])
export const TOGGLE_AUTOMATION_RULE = defineAction('TOGGLE_AUTOMATION_RULE', [SUCCESS, PENDING, ERROR])
