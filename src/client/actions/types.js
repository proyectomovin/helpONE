...
export const FETCH_DASHBOARD_TIMETRACKING_STATS = defineAction('FETCH_DASHBOARD_TIMETRACKING_STATS', [
  SUCCESS,
  PENDING,
  ERROR
])
export const FETCH_DASHBOARD_TIMETRACKING_BY_GROUP = defineAction('FETCH_DASHBOARD_TIMETRACKING_BY_GROUP', [
  SUCCESS,
  PENDING,
  ERROR
])
...
// Time Tracking
export const SET_ESTIMATED_HOURS = defineAction('SET_ESTIMATED_HOURS', [SUCCESS, PENDING, ERROR])
export const ADD_TIME_ENTRY = defineAction('ADD_TIME_ENTRY', [SUCCESS, PENDING, ERROR])
export const UPDATE_TIME_ENTRY = defineAction('UPDATE_TIME_ENTRY', [SUCCESS, PENDING, ERROR])
export const DELETE_TIME_ENTRY = defineAction('DELETE_TIME_ENTRY', [SUCCESS, PENDING, ERROR])
